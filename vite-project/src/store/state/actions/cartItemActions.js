...
export const getCartItems = () => async (dispatch) => {
  try {
    const res = await CartItemService.getAll();
...
export const getCartItemsByUserId = (userId) => async (dispatch) => {
  try {
    ...
    const res = await CartItemService.getByUserId(userId);
...
export const createCartItem = (cartItem) => async (dispatch) => {
  try {
    ...
    debugger
    const res = await CartItemService.create(cartItem);
    debugger
...
export const updateCartItem = (cartItemId, quantity) => async (dispatch) => {
  try {
    const res = await CartItemService.updateQuantity(
      cartItemId,
      quantity
    );
